        ...
        <div class="container z-3">
            <div class="grid grid-cols-1 mt-10">
                ...
                <ul style="background: white !important;"
                    class="inline-block mx-auto sm:w-fit w-full flex-wrap justify-center text-center p-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-t-xl border-b dark:border-gray-800 mt-10"
                ...
                <div id="StarterContent" style="background: white !important;"
                    ...
                    <div class="" id="buy-home" role="tabpanel" aria-labelledby="buy-home-tab">
                        <form action="{{ url('/search-house') }}" method="GET" class="text-start"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <label for="buy-properties" style="color: black" class="form-label font-medium">Select
                                        Categories:</label>
                                    <select name="category" id="buy-properties"
                                            class="form-input bg-white dark:bg-slate-900 mt-2">
